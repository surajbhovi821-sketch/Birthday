...
(function () {
  ...
  const Audio = {
    ...
    duck() {
      ...
      if (uploadedAudio) uploadedAudio.volume = 0.2;
    },
    unduck() {
      if (musicGain && ctx) musicGain.gain.setTargetAtTime(0.5, ctx.currentTime, 0.6);
      if (uploadedAudio) uploadedAudio.volume = 0.7;
    },

...
(function () {
  ...
  S.buildCake = function () {
    ...
    tg.font = "700 88px Georgia, 'Times New Roman', serif";
    tg.textAlign = "center"; tg.textBaseline = "middle";
    tg.shadowColor = "rgba(255,215,140,0.9)"; tg.shadowBlur = 22;
    tg.fillStyle = "#fff3d6";
    const name = (cfg.birthday && cfg.birthday.name || "SEEMA").toUpperCase();
    tg.fillText(name + "  ·  " + (cfg.birthday ? cfg.birthday.age : 21), 512, 80);
